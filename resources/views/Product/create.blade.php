                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('admin/product') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="barcode" type="text" class="form-control{{ $errors->has('sbarcode') ? ' is-invalid' : '' }}" name="barcode" required>                                @if ($errors->has('barcode'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cost_center_code" type="text" class="form-control" name="cost_center_code" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="paper_description" type="text" class="form-control" name="paper_description" required>
                            </div>
                        </div>
